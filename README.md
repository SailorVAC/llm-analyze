...
В `lib/data.ts` лежит mock-каталог из ~12 моделей (Llama 3, Mistral, Qwen 2.5, DeepSeek V2.5, Phi-3, Gemma 2, Command R+, Yi 1.5, Mistral Nemo, Qwen Coder, Falcon). Бенчмарки и цены — на момент добавления; для продакшена подключите свой источник.
